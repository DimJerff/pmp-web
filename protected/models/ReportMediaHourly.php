...
/**
 * 应用每小时报表表数据模型
 * This is the model class for table "{{report_media_hourly}}".
 *
 * The followings are the available columns in table '{{report_media_hourly}}':
 * @property integer $id
 ...
 */
class ReportMediaHourly extends DbActiveRecord
{
	/**
	 ...
	 * @return ReportMediaHourly the static model class
	 */
