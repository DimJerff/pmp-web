...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (hasOptions) {
            ...
            if (typeof options.sameNotCallBack == 'boolean')
                this.sameNotCallBack = options.sameNotCallBack;
    ...
    DateRangePicker.prototype = {
        ...
        hide: function (e) {
            ...
            if (!this.sameNotCallBack || !this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate))
                this.notify();
